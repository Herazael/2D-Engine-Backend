...
- Sandbox demo scene currently draws batched sprites via `buildAndFlushBatch()`.
...
Note: `sandbox/src/main.cpp` currently loads a demo texture from an absolute local path.
